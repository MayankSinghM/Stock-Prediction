...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to the Stock Forecasting App using dash!", className="start"),
                html.Div([
                    html.P("Input Legitimate stock code: "),
                    html.Div([
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://images.unsplash.com/photo-1642621668575-93550304b614?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHN0b2Nrc3xlbnwwfHwwfHx8MA==&w=1000&q=80", "Stocks Forecasting", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
